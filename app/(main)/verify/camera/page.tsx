            ...
            <>
              ...
              <div className="flex gap-2.5">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-3 rounded-xl bg-hyundai-blue-500 text-sm font-medium text-white active:bg-hyundai-blue-600 transition-colors"
                >
                  분석하기
