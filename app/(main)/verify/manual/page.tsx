        ...
        <div className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-hyundai-gray-100 pb-[env(safe-area-inset-bottom,0px)]">
          <div className="max-w-lg mx-auto px-5 py-4">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-hyundai-blue-500 text-white text-sm font-medium active:bg-hyundai-blue-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
